...
const App = () => {
  ...
  const voteModule = sdk.getVoteModule(
    "0x83fD36A90550F1998D9D13d3beF29F39a1C14B7D",
  );
  ...
  const tokenModule = sdk.getTokenModule(
    "0x2b8FDfb353899B7a6da9307CB98f0227894C7EEe"
  );
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>FNSDAO Member Page</h1>
        <p className="subtitle">Welcome to the metaverse!</p>
        <div>
          <div>
            <h2>Member List</h2>
